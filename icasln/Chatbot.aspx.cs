...
namespace icasln
{
    ...
    {
        static string apiKey = "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"; //the api key automatically disallows when more than one person is using it, if it doesnt work try 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
